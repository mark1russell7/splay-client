...
// =============================================================================
// Render Context (splay-compatible)
// =============================================================================
...
// =============================================================================
// Registry Interface (splay-compatible)
// =============================================================================

/**
 * Component renderer function.
 */
export type ComponentRenderer<TOutput = ComponentOutput> = (
  ctx: RenderContext
 ...
 */
export type StreamingComponentRenderer<TOutput = ComponentOutput> = (
  ctx: RenderContext
